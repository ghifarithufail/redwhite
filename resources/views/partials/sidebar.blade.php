...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner pt-2 pb-5">
        ...
        @if (Auth::check() &&
                (Auth::user()->hasRole('super admin') || Auth::user()->hasRole('admin') || Auth::user()->hasRole('Edp')))
        ...
        <!-- CSO -->
        <li class="menu-header small text-uppercase">
            <span class="menu-header-text">CSO</span>
        </li>
        @if (Auth::check() &&
                (Auth::user()->hasRole('super admin') ||
                    Auth::user()->hasRole('admin') ||
                    Auth::user()->hasRole('Cso') ||
                    Auth::user()->hasRole('Owner') ||
                    Auth::user()->hasRole('Edp')))
            <li class="menu-item" style="">
                <a href="javascript:void(0);" class="menu-link menu-toggle">
        ...
        <!-- CSO -->
        {{-- @if (Auth::check() &&
                (Auth::user()->hasRole('super admin') || Auth::user()->hasRole('admin') || Auth::user()->hasRole('Keuangan')))
            <li class="menu-item" style="">
                <a href="javascript:void(0);" class="menu-link menu-toggle">
                    <i class="menu-icon tf-icons bx bx-layout"></i>
        ...
        @if (Auth::check() &&
            ...
            <li class="menu-item" style="">
                <a href="javascript:void(0);" class="menu-link menu-toggle">
                    <i class="menu-icon tf-icons bx bx-layout"></i>
                    <div data-i18n="Payments">Payments Booking</div>
                </a>
        ...
        <li class="menu-item" style="">
            ...
            <ul class="menu-sub">
                ...
                <li class="menu-item">
                    <a href="{{ route('payment/sumary_report') }}" class="menu-link">
                        <div data-i18n="Payment Summary Report">Payment Summary Report</div>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="{{ route('payment/report') }}" class="menu-link">
