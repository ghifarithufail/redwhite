...
@section('content')
    <div class="card text-center">
        <h5 class="card-header">Detail Report SPJ</h5>
    </div>
                        ...
                        @forelse ($spj as $item)
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('spj/print', $item->id) }}">
                                        <button type="button" class="btn rounded-pill btn-primary" fdprocessedid="c80zr4">Donwload SPJ</button>
                                    </a>
                                </td>
