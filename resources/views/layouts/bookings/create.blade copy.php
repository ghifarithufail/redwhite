                ...
                <form method="GET" action="{{ route('bookings.create') }}">
                    ...
                    <div class="row">
                        <div class="col-md-3 col-12 mb-4">
                            ...
                            <input type="date" class="form-control" name="date_start" value="{{ $date_start }}" id="date_start">
                        </div>
                        <div class="col-md-3 col-12 mb-4">
                            <label for="date_end" class="form-label">Tanggal Pulang</label>
                            <input type="date" class="form-control" name="date_end" value="{{ $date_end }}" id="date_end">
                        </div>
                        <div class="col-md-3 col-12 mb-4">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="mb-3 col-md-6">
                        ...
                        <input type="text" name="no_booking" id="no_booking" class="form-control" value="{{ $newBookingNumber }}" disabled>
                    </div>
                    <div class="mb-3 col-md-6">
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <input type="date" name="start" id="start" class="form-control" value="{{ old('start', date('Y-m-d')) }}" required>
                    </div>
                    <div class="mb-3 col-md-6">
                        <label for="end">Tanggal Pulang</label>
                        <input type="date" name="end" id="end" class="form-control" value="{{ old('end', date('Y-m-d')) }}" required>
                    </div>
                    <div class="mb-3 col-md-6">
