                            ...
                            <form action="{{ route('booking.store') }}" method="POST" enctype="multipart/form-data"
                                ...
                                <div id="personal-details"
                                                        ...
                                                        <div class="form-check custom-option custom-option-icon">
                                                            <label class="form-check-label custom-option-content"
                                                                ...
                                                                <span class="custom-option-body">
                                                                    ...
                                                                    <small>{{ $data->nopolisi }} - {{$data->type_armada->name}}</small>
                                                                </span>
                                    ...
                                    <div class="row g-3 mt-3">
                                        ...
                                        <div class="col-sm-6 fv-plugins-icon-container">
                                            <label class="form-label" for="harga_std">Lokasi Jemput</label>
                                            <input type="text" id="lokasi_jemput" name="lokasi_jemput"
                                                class="form-control">
                                        </div>
                                        <div class="col-sm-6 fv-plugins-icon-container">
                                            <label class="form-label" for="harga_std">Biaya Jemput</label>
                                            <input type="text" id="biaya_jemput" value="0" name="biaya_jemput"
                                                class="form-control">
                                        </div>
                                        <div class="col-sm-6">
