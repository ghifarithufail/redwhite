                        ...
                        <table width="100%">
                            ...
                            <tr>
                                <td width="50%" colspan="2">
                                    <table width="100%">
                                        <tr>
                                            <td width="60%"><span class="font-20"><b>No Booking</b> :
                                                    {{ $booking->no_booking }}</span></td>
                                            <td width="40%">
                ...
                <tr>
                    <td width="70%" valign="top">
                        <table width="100%" class="detail1">
							...
							<tr>
                                ...
                                <td width="75%" class="bold" valign="top">: {{ $booking->tujuan->nama_tujuan }}</td>
                            </tr>
                            <tr>
                            ...
                            {{-- <tr>
                                <td width="25%" valign="top">Total Bus</td>
                                <td width="75%" class="bold" valign="top">: {{ $booking->total_bus }}</td>
                            </tr> --}}
                        </table>
                    </td>
                    <td width="30%" valign="top">
                        <table width="100%">
                            <tr>
                                <td>
                                    <div>Tanggal Awal Pemakaian :</div>
                                    <div class="font-16">
                                        <center><b>{{ date('d/m/Y', strtotime($booking->date_start)) }}</b></center>
                                    </div>
                                    <hr class="devider2">
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <div>Tanggal Akhir Pemakaian :</div>
                                    <div class="font-16">
                                        <center><b>{{ date('d/m/Y', strtotime($booking->date_end)) }}</b></center>
                                    </div>
                                    <hr class="devider2">
                                </td>
                            </tr>
                ...
                <tr>
                    ...
                    <td width="30%" valign="top">
                        <table width="100%">
                            ...
                            <tr>
                                <td>
                                    <div>Total Harga Booking :</div>
                                    <div class="font-16">
                                        <center><b>Rp.{{ number_format($booking->grand_total) }} </b></center>
                                    </div>
                                    <hr class="devider2">
                                </td>
                            </tr>
                        ...
                        <table width="100%" style="margin-top: -13px;">
                            <tr>
                                <td width="33%" align="center"
                                    style="padding-top: 10px; border-left: 2px double #555;">
                                    <span class="font-16">Membuat</span>
                                    <div style="height: 120px;"></div>
                                    <span class="font-16"
                                        style="text-transform: uppercase;">{{ $booking->users->name }}</span>
                                </td>
                                <td width="33%" align="center"
                                    style="padding-top: 10px; border-left: 2px double #555; border-right: 2px double #555;">
                                    <span class="font-16">Customer</span>
                                    <div style="height: 120px;"></div>
                                    <span class="font-16"
                                        style="text-transform: uppercase;">{{ $booking->customer }}</span>
                                </td>
                        ...
                        <table width="100%" style="margin-top: -5px">
                            <tr>
                                <td class="font-14 justify">
                                    Dengan menandatangani Surat Bukti Booking ini, kedua belah pihak sepakat dan setuju
                                    bahwa bukti booking ini merupakan butik sah yang dikeluarkan oleh primajasa dan
