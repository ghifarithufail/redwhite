...
<html lang="en">
  ...
  <head>
    ...
    <title>Primajasa - Redwhite Star</title>

    <!-- Bootstrap core CSS -->
    <link href="{{ asset('scolar/vendor/bootstrap/css/bootstrap.min.css') }}" rel="stylesheet">


    <!-- Additional CSS Files -->
    <link rel="stylesheet" href="{{ asset('scolar/assets/css/fontawesome.css') }}">
    <link rel="stylesheet" href="{{ asset('scolar/assets/css/templatemo-scholar.css') }}">
    <link rel="stylesheet" href="{{ asset('scolar/assets/css/owl.css') }}">
    <link rel="stylesheet" href="{{ asset('scolar/assets/css/animate.css') }}">
                ...
                <nav class="main-nav">
                    ...
                    <ul class="nav">
                      ...
                      <li><a href="#specials">Specials</a>
                        <ul class="dropdown">
                          <li><a href="#service1">Special 1</a></li>
          ...
          <div class="owl-carousel owl-banner">
            <div class="item item-1">
              <div class="header-text">
                <span class="category">Kami adalah</span>
                <h2>Primajasa Melayani sejak tahun 1991</h2>
                ...
                <div class="buttons">
                  ...
                  <div class="icon-button">
                    <a href="#"><i class="fa fa-play"></i> Kenapa Primajasa</a>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div class="row">
        <div class="col-lg-4 col-md-6">
          <div class="service-item">
            <div class="icon">
              <img src="{{ asset('scolar/assets/images/service-01.png') }}" alt="online degrees">
            </div>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="service-item">
            <div class="icon">
              <img src="{{ asset('scolar/assets/images/service-02.png') }}" alt="short courses">
            </div>
            <div class="main-content">
              <h4>Short Courses</h4>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="service-item">
            <div class="icon">
              <img src="{{ asset('scolar/assets/images/service-03.png') }}" alt="web experts">
            </div>
            <div class="main-content">
              <h4>Web Experts</h4>
...
<section id="specials" class="specials">
    ...
    <div class="row">
      <div class="section-title">
        <h2>Transportasi untuk Segala Kebutuhan</h2>
        <p>Pilih sesuai kebutuhan Kamu !</p>
      </div>
      ...
      <div class="row" data-aos="fade-up" data-aos-delay="100">
        <div class="col-lg-3">
          <ul class="nav nav-tabs flex-column">
            <li class="nav-item">
              <a class="nav-link active show" data-bs-toggle="tab" href="#tab-1">Bus Antar Kota</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" data-bs-toggle="tab" href="#tab-2">Sewa Bus Pariwisata</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" data-bs-toggle="tab" href="#tab-3">Bus ke Bandara Soetta</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" data-bs-toggle="tab" href="#tab-4">Taksi</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" data-bs-toggle="tab" href="#tab-5">Travel/Shuttle</a>
            </li>
          </ul>
        </div>
        <div class="col-lg-9 mt-4 mt-lg-0">
          <div class="tab-content">
            <div class="tab-pane active show" id="tab-1">
              <div class="row">
                <div class="col-lg-8 details order-2 order-lg-1">
                  <h3>Layanan di Tiga Provinsi</h3>
                  <p class="fst-italic">Kami telah berpengalaman sejak tahun 1991 melayani masyarakat dengan menyediakan jasa transportasi bis Antar Kota Antar Propinsi (AKAP) dan Antar Kota Dalam Propinsi (AKDP), di Provinsi DKI Jakarta, Provinsi Banten dan Provinsi Jawa Barat</p>
                  <p>EKONOMIS - TEPAT WAKTU - AMAN adalah Tag Line kami</p>
                </div>
                <div class="col-lg-4 text-center order-1 order-lg-2">
                  <img src="{{ asset('img/bus_kiri.png') }}" alt="" class="img-fluid">
                </div>
              </div>
            </div>
            <div class="tab-pane" id="tab-2">
              <div class="row">
                <div class="col-lg-8 details order-2 order-lg-1">
                  <h3>Pilihan Kenyamanan Liburan Tanpa Khawatir,Perjalanan Aman, Wisata Menyenangkan</h3>
  ...
  {{-- <section class="section courses" id="courses" >
    <div class="container">
      ...
      <ul class="event_filter">
        ...
        <li>
          <a href="#!" data-filter=".design">Bus Reguler</a>
        </li>
        <li>
          <a href="#!" data-filter=".development">Bus Bandara</a>
        </li>
        <li>
          <a href="#!" data-filter=".wordpress">Sewa Bus Pariwisata</a>
        </li>
        <li>
            <a href="#!" data-filter=".wordpress">Taksi</a>
        </li>
        <li>
        <a href="#!" data-filter=".wordpress">Travel</a>
        </li>
      </ul>
      <div class="row event_box">
        <div class="col-lg-4 col-md-6 align-self-center mb-30 event_outer col-md-6 design">
          <div class="events_item">
            <div class="thumb">
              <a href="#"><img src="{{ asset('scolar/assets/images/course-01.jpg') }}" alt=""></a>
        ...
        <div class="col-lg-4 col-md-6 align-self-center mb-30 event_outer col-md-6  development">
          <div class="events_item">
            <div class="thumb">
              <a href="#"><img src="{{ asset('scolar/assets/images/course-02.jpg') }}" alt=""></a>
        ...
        <div class="col-lg-4 col-md-6 align-self-center mb-30 event_outer col-md-6 design wordpress">
          <div class="events_item">
            <div class="thumb">
              <a href="#"><img src="{{ asset('scolar/assets/images/course-03.jpg') }}" alt=""></a>
        ...
        <div class="col-lg-4 col-md-6 align-self-center mb-30 event_outer col-md-6 development">
          <div class="events_item">
            <div class="thumb">
              <a href="#"><img src="{{ asset('scolar/assets/images/course-04.jpg') }}" alt=""></a>
              <span class="category">Development</span>
        ...
        <div class="col-lg-4 col-md-6 align-self-center mb-30 event_outer col-md-6 wordpress development">
          <div class="events_item">
            <div class="thumb">
              <a href="#"><img src="{{ asset('scolar/assets/images/course-05.jpg') }}" alt=""></a>
              <span class="category">Wordpress</span>
        ...
        <div class="col-lg-4 col-md-6 align-self-center mb-30 event_outer col-md-6 wordpress design">
          <div class="events_item">
            <div class="thumb">
              <a href="#"><img src="{{ asset('scolar/assets/images/course-06.jpg') }}" alt=""></a>
              <span class="category">Webdesign</span>
      ...
      <div class="row">
        <div class="col-lg-3 col-md-6">
          <div class="team-member">
            <div class="main-content">
              <img src="{{ asset('scolar/assets/images/member-01.jpg') }}" alt="">
        ...
        <div class="col-lg-3 col-md-6">
          <div class="team-member">
            <div class="main-content">
              <img src="{{ asset('scolar/assets/images/member-02.jpg') }}" alt="">
        ...
        <div class="col-lg-3 col-md-6">
          <div class="team-member">
            <div class="main-content">
              <img src="{{ asset('scolar/assets/images/member-03.jpg') }}" alt="">
        ...
        <div class="col-lg-3 col-md-6">
          <div class="team-member">
            <div class="main-content">
              <img src="{{ asset('scolar/assets/images/member-04.jpg') }}" alt="">
        ...
        <div class="col-lg-7">
          <div class="owl-carousel owl-testimonials">
            <div class="item">
              ...
              <div class="author">
                <img src="{{ asset('scolar/assets/images/testimonial-author.jpg') }}" alt="">
                <span class="category">Full Stack Master</span>
                <h4>Claude David</h4>
              </div>
            </div>
        ...
        <div class="col-lg-12 col-md-6">
          <div class="item">
            <div class="row">
              <div class="col-lg-3">
                <div class="image">
                  <img src="{{ asset('scolar/assets/images/event-01.jpg') }}" alt="">
                </div>
              </div>
              <div class="col-lg-9">
                <ul>
        ...
        <div class="col-lg-12 col-md-6">
          <div class="item">
            <div class="row">
              <div class="col-lg-3">
                <div class="image">
                  <img src="{{ asset('scolar/assets/images/event-02.jpg') }}" alt="">
                </div>
              </div>
              <div class="col-lg-9">
                <ul>
        ...
        <div class="col-lg-12 col-md-6">
          <div class="item">
            <div class="row">
              <div class="col-lg-3">
                <div class="image">
                  <img src="{{ asset('scolar/assets/images/event-03.jpg') }}" alt="">
                </div>
              </div>
              <div class="col-lg-9">
                <ul>
  ...
  <script src="{{ asset('scolar/vendor/jquery/jquery.min.js') }}"></script>
  <script src="{{ asset('scolar/vendor/bootstrap/js/bootstrap.min.js') }}"></script>
  <script src="{{ asset('scolar/assets/js/isotope.min.js') }}"></script>
  <script src="{{ asset('scolar/assets/js/owl-carousel.js') }}"></script>
  <script src="{{ asset('scolar/assets/js/counter.js') }}"></script>
  <script src="{{ asset('scolar/assets/js/custom.js') }}"></script>
