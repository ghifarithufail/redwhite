...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner pt-2 pb-5">
        ...
        @if (Auth::check() && (Auth::user()->hasRole('super admin') || Auth::user()->hasRole('admin') || Auth::user()->hasRole('edp')))
            <li class="menu-item" style="">
                ...
                <ul class="menu-sub">
                    ...
                    <li class="menu-item">
                        <a href="{{ route('pool.index') }}" class="menu-link">
                            <div data-i18n="Pool">Pool</div>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="{{ route('rute.index') }}" class="menu-link">
            ...
            <li class="menu-item" style="">
                ...
                <ul class="menu-sub">
                    ...
                    <li class="menu-item">
                        <a href="{{ route('kota.index') }}" class="menu-link">
        ...
        @endif
       <!-- HRD -->
       @if (Auth::check() && (Auth::user()->hasRole('super admin') || Auth::user()->hasRole('admin') || Auth::user()->hasRole('hrd')
            || Auth::user()->hasRole('owner') || Auth::user()->hasRole('manager') || Auth::user()->hasRole('edp')))
            <li class="menu-item" style="">
                <a href="javascript:void(0);" class="menu-link menu-toggle">
                    <i class="menu-icon tf-icons bx bx-layout"></i>
                ...
                <ul class="menu-sub">
                    ...
                    <li class="menu-item">
                        <a href="{{ route('pengemudi.index') }}" class="menu-link">
                            <div data-i18n="Pengemudi">Pengemudi</div>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="{{ route('kondektur.index') }}" class="menu-link">
        ...
        <!-- OPERASI -->
        @if (Auth::check() &&  (Auth::user()->hasRole('super admin') || Auth::user()->hasRole('admin') || Auth::user()->hasRole('operasi')
            || Auth::user()->hasRole('owner') || Auth::user()->hasRole('manager') || Auth::user()->hasRole('edp')))
            <li class="menu-item" style="">
                <a href="javascript:void(0);" class="menu-link menu-toggle">
                    <i class="menu-icon tf-icons bx bx-layout"></i>
                    <div data-i18n="Operasional">Operasional</div>
                </a>
                ...
                <ul class="menu-sub">
                    ...
                    <li class="menu-item">
                        <a href="{{ route('kondektur.show') }}" class="menu-link">
                            <div data-i18n="Jadwal Kondektur">Jadwal Kondektur</div>
                        </a>
                    </li>
                    <li class="menu-item">
        ...
        <!-- CSO -->
        @if (Auth::check() &&  (Auth::user()->hasRole('super admin') || Auth::user()->hasRole('admin') || Auth::user()->hasRole('cso')
            || Auth::user()->hasRole('owner') || Auth::user()->hasRole('edp')))
            <li class="menu-item" style="">
                <a href="javascript:void(0);" class="menu-link menu-toggle">
                    <i class="menu-icon tf-icons bx bx-layout"></i>
                ...
                <ul class="menu-sub">
                    ...
                    <li class="menu-item">
                        <a href="{{ route('tujuan.index') }}" class="menu-link">
                            <div data-i18n="Tujuan">Tujuan</div>
                        </a>
                    </li>
                    {{-- <li class="menu-item">
        ...
        @if (Auth::check() &&  (Auth::user()->hasRole('super admin') || Auth::user()->hasRole('admin')
         || Auth::user()->hasRole('owner') || Auth::user()->hasRole('keuangan') || Auth::user()->hasRole('accounting')))
    <li class="menu-item" style="">
            <li class="menu-item" style="">
                <a href="javascript:void(0);" class="menu-link menu-toggle">
                    <i class="menu-icon tf-icons bx bx-layout"></i>
        ...
        <li class="menu-item" style="">
            ...
            <ul class="menu-sub">
                <li class="menu-item">
                    <a href="{{ route('bookingLaporan') }}" class="menu-link">
