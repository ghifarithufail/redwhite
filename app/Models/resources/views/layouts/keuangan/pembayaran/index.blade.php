                ...
                <form method="GET" action="{{ route('pembayaran') }}">
                    ...
                    <div class="row">
                        ...
                        <div class="add-new-role">
                            <!-- Tombol "Add New Role" -->
                            <a href="{{ route('pembayaran.create') }}" class="btn btn-primary mb-2 text-nowrap">
                                + Booking
                            </a>
                        </div>
                    </div>
            ...
            <table class="table table-hover" style="zoom: 0.85">
                ...
                <tbody class="table-border-bottom-0">
                    ...
                    <tr>
                        ...
                        <td>{{ $data->bookings->no_booking ?? 'N/A' }}</td>
                        <td>{{ $data->bookings->customer ?? 'N/A' }}</td>
                        <td>{{ $data->bookings->telephone ?? 'N/A' }}</td>
