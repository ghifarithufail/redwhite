                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="date" value="{{ Carbon\Carbon::parse($booking->start_date)->format('Y-m-d') }}" disabled class="form-control" />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="date" value="{{ Carbon\Carbon::parse($booking->end_date)->format('Y-m-d') }}" disabled class="form-control" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" value="@foreach ($booking->tujuans as $key => $item){{ $item->nama_tujuan }}@if (!$loop->last), @endif @endforeach" disabled class="form-control" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 mt-4">
                        ...
                        <form action="{{ route('pembayaran.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <input type="number" value="{{ $booking->id }}" name="booking_id" class="form-control input-quantity" hidden required>
