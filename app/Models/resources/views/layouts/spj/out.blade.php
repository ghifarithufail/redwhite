...
<head>
    ...
    <style>
        ...
        .bold-italic {
            font-weight: bold;   /* Menetapkan teks menjadi tebal */
            font-style: italic;  /* Menetapkan teks menjadi miring */
        }
    </style>
</head>
    ...
    <div id="receipt">
        <div id="section">
            <div class="row">
                ...
                <h4 class="bold-italic"> PT. PRIMAJASA PERDANARAYA<br>Jl. Moh. Toha No.1 (Ciputat-Parung) Wates,<br>Pondok Cabe Telp. (021) 74703339</h4>
            </div>
            <center>
            ...
            <div style="padding: 10px; font-size: 16px;">
                <table>
                    ...
                    <tr>
                        ...
                        <td width="1%">:</td>
                        <td>{{ $spj->booking_details->armadas->nobody }} / {{ $spj->booking_details->armadas->nopolisi }}
                        </td>
                    </tr>
                    <tr>
