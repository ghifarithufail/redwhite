...
class BiodataControllerr extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('biodata')->with('success', 'Biodata and user have been created successfully!');
        } catch (\Exception $e) {
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            return redirect()->route('biodata')->with('success', 'Biodata has been updated successfully!');
        } catch (\Exception $e) {
            // Rollback transaksi jika terjadi error
            DB::rollBack();
    ...
    public function destroy(string $id)
    {
        ...
        return redirect()->route('biodata')->with('success', 'Biodata has been deleted successfully!');
    }
}
